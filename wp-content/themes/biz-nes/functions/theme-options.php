	...
	$custom_settings = array(
		'contextual_help' => array(
			'content' => array(
				array(
					...
					'content' => '<p>' . __( 'Акунаматата', 'theme-text-domain' ) . '</p>',
				),
			),
		...
		'settings'        => array(
			/*логотип для шапки*/
				array(
				'id'           => 'header_tab',
				'label'        => __( 'Основні', 'theme-text-domain' ),
				'desc'         => '',
				'type'         => 'tab',
				'section'      => 'header',
			),
			array(
				...
				'desc'         => sprintf( __( 'Завантажте логотип для шапки сайту' ), apply_filters( 'ot_upload_text', __( 'Send to OptionTree', 'theme-text-domain' ) ), 'FTP' ),
				'type'         => 'upload',
				'section'      => 'header',
			),
			array(
				'id'           => 'desc_on_off',
				'label'        => __( 'Виключення опису сайту', 'theme-text-domain' ),
				'desc'         => '',
				'std'          => 'off',
				'type'         => 'on-off',
				'section'      => 'header',
			...
			/*Контакти */
				...
				array(
				'id'           => 'headers_cont_open',
				'label'        => __( 'Часи роботи', 'theme-text-domain' ),
				'desc'         => '',
				'std'          => '',
				'type'         => 'text',
				'section'      => 'header',
...
/*зворотний звязок*/  	
				...
				array(
				'id'           => 'header_feedback_on-off',
				'label'        => __( 'Вкл/Викл зворотний звязок', 'theme-text-domain' ),
				'std'          => 'on',
				'type'         => 'on-off',
				'section'      => 'header',
			),
				array(
				'id'           => 'headers_feedback_title',
				...
				array(
				'id'           => 'headers_feedback_form',
				'label'        => __( 'Форма зворотнього звязку', 'theme-text-domain' ),
				'desc'         => 'Добавти це поле в шорткод плагіну Contact Form 7',
				'std'          => '',
				'type'         => 'text',
				'section'      => 'header',
				'condition'    =>'header_feedback_on-off:is(on)',
